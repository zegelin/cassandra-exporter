...
public class GossiperMBeanMetricFamilyCollector implements MBeanMetricFamilyCollector {
    ...
    public Stream<MetricFamily<?>> collect() {
        ...
        for (final Map.Entry<InetAddress, EndpointState> endpointState : endpointStates) {
            ...
            final ImmutableMap<String, String> labels = ImmutableMap.of("endpoint", InetAddresses.toAddrString(endpoint));
