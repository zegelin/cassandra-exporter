...
//
//    private static final AsciiString CHARSET_EQUALS = AsciiString.of(HttpHeaders.Values.CHARSET + "=");
...
//        if (connection != null && HttpHeaders.Values.CLOSE.contentEqualsIgnoreCase(connection)) {
//            return false;
//        }
//
//        if (message.protocolVersion().isKeepAliveDefault()) {
//            return !HttpHeaders.Values.CLOSE.contentEqualsIgnoreCase(connection);
//        } else {
//            return HttpHeaders.Values.KEEP_ALIVE.contentEqualsIgnoreCase(connection);
//        }
//    }
//
//    /**
...
//        String value = message.headers().get(HttpHeaders.Names.CONTENT_LENGTH);
//        if (value != null) {
...
//
//        // Otherwise we don't.
//        throw new NumberFormatException("header not found: " + HttpHeaders.Names.CONTENT_LENGTH);
//    }
//
//    /**
...
//                    h.contains(HttpHeaders.Names.SEC_WEBSOCKET_KEY1) &&
//                    h.contains(HttpHeaders.Names.SEC_WEBSOCKET_KEY2)) {
//                return 8;
//            }
//        } else if (message instanceof HttpResponse) {
//            HttpResponse res = (HttpResponse) message;
//            if (res.getStatus().code() == 101 &&
//                    h.contains(HttpHeaders.Names.SEC_WEBSOCKET_ORIGIN) &&
//                    h.contains(HttpHeaders.Names.SEC_WEBSOCKET_LOCATION)) {
//                return 16;
//            }
//        }
//
...
//        return m.headers().contains(HttpHeaders.Names.CONTENT_LENGTH);
//    }
//
//    /**
...
//        }
//
//        final String expectValue = message.headers().get(HttpHeaders.Names.EXPECT);
//        // unquoted tokens in the expect header are case-insensitive, thus 100-continue is case insensitive
//        return HttpHeaders.Values.CONTINUE.toString().equalsIgnoreCase(expectValue);
//    }
//
//    /**
...
//
//        final String expectValue = message.headers().get(HttpHeaders.Names.EXPECT);
//        return expectValue != null && !HttpHeaders.Values.CONTINUE.toString().equalsIgnoreCase(expectValue);
//    }
//
...
//                message.getProtocolVersion().compareTo(HttpVersion.HTTP_1_1) >= 0;
//    }
//
//    /**
...
//        if (expected) {
//            message.headers().set(HttpHeaders.Names.EXPECT, HttpHeaders.Values.CONTINUE);
//        } else {
//            message.headers().remove(HttpHeaders.Names.EXPECT);
//        }
//    }
//
//    /**
...
//        return message.headers().contains(HttpHeaders.Names.TRANSFER_ENCODING, HttpHeaders.Values.CHUNKED, true);
//    }
//
//    /**
//     * Set the {@link HttpHeaders.Names#TRANSFER_ENCODING} to either include {@link HttpHeaders.Values#CHUNKED} if
//     * {@code chunked} is {@code true}, or remove {@link HttpHeaders.Values#CHUNKED} if {@code chunked} is {@code false}.
//     * @param m The message which contains the headers to modify.
//     * @param chunked if {@code true} then include {@link HttpHeaders.Values#CHUNKED} in the headers. otherwise remove
//     * {@link HttpHeaders.Values#CHUNKED} from the headers.
//     */
//    public static void setTransferEncodingChunked(HttpMessage m, boolean chunked) {
//        if (chunked) {
//            m.headers().set(HttpHeaders.Names.TRANSFER_ENCODING, HttpHeaders.Values.CHUNKED);
